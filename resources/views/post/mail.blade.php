    <section class="content-mail">
      <div class="row-mail">
        <div class="col-md-9">
          <div class="card-mail card-primary card-outline">
            <div class="card-header-mail">             
              <ul class="nav-mail">
                <li class="btn-createMail">
                  <button class="btn-crMail">
                    <div class="svg-wrapper-1">
                      <div class="svg-wrapper">
                        <img src="{{asset('img/icon/crMail.svg')}}" class="img-crMail" alt="">
                      </div>
                    </div>
                    <span>Send</span>
                  </button> 
                ...
                <li class="nav-item active">
                    <a href="#" class="nav-link">
                      <i class="fas fa-inbox"></i> favourite
            ...
            <!-- /.card-body -->
            <div class="card-footer-mail p-0">
              <div class="mailbox-controls">
                <!-- Check all button -->
                <div class="btn-mail">
